...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(124, 255, 85),
...
if not isfile("Obsidian/assets/TransparencyTexture.png") then
    writefile("Obsidian/assets/TransparencyTexture.png", "https://github.com/sametexe001/images/blob/main/icon1.png?raw=true")
end

if not isfile("Obsidian/assets/SaturationMap.png") then
    writefile("Obsidian/assets/SaturationMap.png", "https://github.com/sametexe001/images/blob/main/icon2.png?raw=true")
end
