...
function library:create_settings_tab(menu)
    ...
    local theme_settings = tab:section({text = 'theme', side = 1})
    ...
    theme_settings:colorpicker({text = 'accent', flag = 'theme_accent', default = library.themes.default.Accent, callback = function(color)library.theme.Accent = color library:update_theme()end})
    theme_settings:colorpicker({text = 'background', flag = 'theme_background', default = library.themes.default.Background, callback = function(color)library.theme.Background = color library:update_theme()end})
    theme_settings:colorpicker({text = 'group background', flag = 'theme_group_background', default = library.themes.default["Group Background"], callback = function(color)library.theme["Group Background"] = color library:update_theme()end})
    theme_settings:colorpicker({text = 'border', flag = 'theme_border', default = library.themes.default.Border, callback = function(color)library.theme.Border = color library:update_theme()end})
    theme_settings:colorpicker({text = 'border 2', flag = 'theme_border2', default = library.themes.default["Border 2"], callback = function(color)library.theme["Border 2"] = color library:update_theme()end})
    theme_settings:colorpicker({text = 'border 3', flag = 'theme_border3', default = library.themes.default["Border 3"], callback = function(color)library.theme["Border 3"] = color library:update_theme()end})
    theme_settings:colorpicker({text = 'primary text', flag = 'theme_primary_text', default = library.themes.default["Primary Text"], callback = function(color)library.theme["Primary Text"] = color library:update_theme()end})
    theme_settings:colorpicker({text = 'secondary text', flag = 'theme_secondary_border', default = library.themes.default["Secondary Text"], callback = function(color)library.theme["Secondary Text"] = color library:update_theme()end})

    settings_main:toggle({text = 'keybind indicator', flag = 'keybind_indicator_enabled', callback = function(bool)library.keybind_indicator:set_enabled(bool)end})
    ...
    settings_main:button({text = 'copy javascript invite', callback = function()setclipboard('Roblox.GameLauncher.joinGameInstance('..game.PlaceId..',"'..game.JobId..'")')end})
    settings_main:button({text = 'rejoin', confirm = true, callback = function()game:GetService('TeleportService'):Teleport(game.PlaceId, game.Players.LocalPlayer)end})
